...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `asciidoc` grammar compiled for Highlight.js 11.7.0 */
...
}}})();hljs.registerLanguage("asciidoc",e)})();/*! `wasm` grammar compiled for Highlight.js 11.7.0 */
